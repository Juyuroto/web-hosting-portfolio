...
- [PC Admin – Configuration complète sous Manjaro GNOME](#pc-admin--configuration-complète-sous-manjaro-gnome)
  - [Objectif](#objectif)
  - [Sommaire](#sommaire)
  - [Pages](#pages)
  - [Prérequis matériels et logiciels](#prérequis-matériels-et-logiciels)
  - [1 - Installation de Manjaro GNOME](#1---installation-de-manjaro-gnome)
  - [2 - Installation des applications essentielles](#2---installation-des-applications-essentielles)
      - [Gestion de fichiers](#gestion-de-fichiers)
      - [Navigateur Web](#navigateur-web)
      - [Machines virtuelles / Proxmox](#machines-virtuelles--proxmox)
      - [Gestion des fenêtres pour autostart](#gestion-des-fenêtres-pour-autostart)
  - [3 - Création du script d’autostart](#3---création-du-script-dautostart)
      - [Créer le dossier ~/bin](#créer-le-dossier-bin)
      - [Créer le script startup-apps.sh](#créer-le-script-startup-appssh)
      - [Contenu du script](#contenu-du-script)
      - [Rendre le script exécutable](#rendre-le-script-exécutable)
  - [4 - Lancer le script automatiquement au démarrage](#4---lancer-le-script-automatiquement-au-démarrage)
      - [Créer un fichier .desktop](#créer-un-fichier-desktop)
